...
const PhoneCard = ({ phone }) => {
  ...
  const handleAddToFavorites = () => {
    ...
    // jookhon kisu nai tokhon if er moddhe dhukba
    if (!favoriteItem) {
      addedFavoritesArray.push(phone);
      localStorage.setItem("favorites", JSON.stringify(addedFavoritesArray));
      Swal.fire("Phone!", "Added to Favorites", "success");
    } else {
      ...
      if (!isExists) {
        ...
        Swal.fire("Phone!", "Already Added", "error");
      }
    }
    // console.log(favoriteItem);
    // const eachPhone = localStorage.setItem("favorites", JSON.stringify(phone));
    // setPhones(favoriteItem, eachPhone);
  };
  return (
